...
namespace Tabulation_Fib_Grid_Recipe
{
    class Program
    {
        static void Main()
        {
            ...
            Console.WriteLine("Grid Traveler Tabulation: " + GridTraveler(3, 3));
        ...
        //[ 0 1 2 3 4 ]
        // ...
        public static int GridTraveler(int m, int n) // Time O(n) Space O(n) 
        {
            var size1 = n + 2;  //rows
            var size2 = m + 2;  //cols
        ...
        public static int GridTraveler2(int m, int n) // Time O(n) Space O(n) 
        {
            var size1 = n + 1;  //rows
            var size2 = m + 1;  //cols
            var table = new int[size1, size2]; //Array fill with 0s
