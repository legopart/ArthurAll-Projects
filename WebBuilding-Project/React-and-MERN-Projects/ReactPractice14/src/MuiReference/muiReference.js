...
export default class MuiReference extends Component {
  state = {  } 
  render() {
    ...
    return (
      <MuiStyle>
        <Mui.Container maxWidth="xs">
            ...
            <HideOnScroll {...this.props}><Mui.AppBar color="secondary" position="fixed" sx={{maxHeight: '50px ! important'}}>
                <Mui.Toolbar>
          ...
          <button onClick={()=>this?.props?.navigation("/2")}>Home/2</button>
