...
using System.IO;
namespace DataStructures.z_Examin_LoadDataFromFile.Classes
{
    public class HalmasManage
    {
        private string FILE_NAME = System.IO.Directory.GetCurrentDirectory() + @"\z_Examin_LoadDataFromFile\HALMAS.csv";
